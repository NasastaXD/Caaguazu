 ...
 * para repetirlo. Espera $page_title en scope.
 */
...
$titulo   = isset( $page_title ) ? (string) $page_title : '';
$en_home  = 'home' === promotur_current_route();
?>
<header class="promotur-topbar">
	...
	<nav class="promotur-breadcrumb" aria-label="<?php esc_attr_e( 'Navegación del panel', 'caaguazu-portal' ); ?>">
		<span class="promotur-breadcrumb__icon" aria-hidden="true"><?php echo promotur_icon( 'apps' ); // phpcs:ignore WordPress.Security.EscapeOutput ?></span>
		<?php if ( $en_home ) : ?>
			<span class="promotur-breadcrumb__aqui"><?php echo esc_html( $titulo ); ?></span>
		<?php else : ?>
			<a href="<?php echo esc_url( promotur_url( 'panel' ) ); ?>"><?php esc_html_e( 'Inicio', 'caaguazu-portal' ); ?></a>
			<span class="promotur-breadcrumb__sep" aria-hidden="true">/</span>
			<span class="promotur-breadcrumb__aqui" aria-current="page"><?php echo esc_html( $titulo ); ?></span>
		<?php endif; ?>
	</nav>
