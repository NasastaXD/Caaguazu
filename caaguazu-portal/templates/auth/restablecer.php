...
$body = function () use ( $error, $login, $key, $valid_key ) {
	...
	<?php if ( $valid_key ) : ?>
		<form class="promotur-form" method="post">
			...
			<label class="promotur-field">
				<span><?php esc_html_e( 'Nueva contraseña (6 o más caracteres)', 'caaguazu-portal' ); ?></span>
	...
	<?php else : ?>
		<p class="promotur-auth__sub"><?php esc_html_e( 'El enlace no es válido o ya venció. Pedí uno nuevo.', 'caaguazu-portal' ); ?></p>
