...
$page_title = __( 'No encontramos esa sección', 'caaguazu-portal' );
$body = function () {
	?>
	<div class="promotur-empty-box promotur-card">
		...
		<p class="promotur-muted"><?php esc_html_e( 'Puede que el enlace esté roto o que no tengas permiso para acceder.', 'caaguazu-portal' ); ?></p>
