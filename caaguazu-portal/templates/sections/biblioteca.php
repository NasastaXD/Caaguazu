...
$body = function () {
	...
	<div class="promotur-card promotur-empty-box">
		<p><?php esc_html_e( 'Tu galería de fotos, con créditos y atribución. Por ahora, las imágenes se suben directamente desde el editor de cada ficha.', 'caaguazu-portal' ); ?></p>
		<a class="promotur-btn promotur-btn--ghost" href="<?php echo esc_url( admin_url( 'upload.php' ) ); ?>"><?php esc_html_e( 'Abrir biblioteca de WordPress', 'caaguazu-portal' ); ?></a>
	</div>
	<?php
};
