...
- **`apply_filters( 'caaguazu_quick_access_items', array() )`** — cada plugin agrega su propia tarjeta al grid de accesos rápidos del home. Item: `array( 'icon', 'label', 'url' )`.
