...
<a class="eco-card" href="#tourism-link:contacto#"><div class="body"><span class="eco-tag">Turismo</span><h3>Contacto</h3><p class="desc">Secretaría de Turismo de la Municipalidad de Caaguazú.</p><span class="arrow">Ver sección →</span></div></a>
  ...
  array (
    ...
    'body' => '<h2>Qué se puede ver</h2><p>Aserraderos en funcionamiento, carpinteros ensamblando muebles y puestos familiares que venden juguetes de madera. Sillas, mesas, roperos, parquets y puertas talladas se exhiben y se venden directamente en los talleres.</p><h2>Cómo recorrerla</h2><ul><li>Tramo principal: entre los km 175 y 185 de la Ruta 7.</li><li>Horario recomendado: 9 a 17 h, días hábiles.</li><li>Acceso en auto propio o en cualquier bus que cubra el trayecto Asunción–Ciudad del Este (solicitar parada en Caaguazú).</li><li>Los precios suelen ser negociables. Se recomienda pago en efectivo, en guaraníes.</li></ul><a href="#tourism-link:planifica-tu-visita/como-llegar#">Cómo llegar →</a><a href="#tourism-link:la-capital-de-la-madera/artesanos#">Ver artesanos →</a>',
  ),
  'artesania-y-oficios' =>
  array (
  ...
  array (
    ...
    'body' => '<a href="#tourism-link:que-hacer/ykua-la-patria#"><img src="https://images.unsplash.com/photo-1502082553048-f009c37129b9?w=1600&auto=format&fit=crop&q=80" alt="Manantial natural rodeado de vegetación" loading="lazy"><p>Sitio fundacional</p><h3>Ykua La Patria</h3><p>El manantial donde se fundó la ciudad. Parque histórico con monolito conmemorativo de 1845.</p></a><a href="#tourism-link:la-capital-de-la-madera/la-ruta-de-la-madera#"><img src="https://images.unsplash.com/photo-1542273917363-3b1817f69a2d?w=1200&auto=format&fit=crop&q=80" alt="Detalle de troncos y veta de madera apilada" loading="lazy"><p>Recorrido</p><h3>La Ruta de la Madera</h3><p>Talleres abiertos sobre la Ruta 7, con carpinteros trabajando y muebles y juguetes a la venta.</p></a><a href="#tourism-link:que-hacer/patrimonio-religioso#"><img src="https://images.unsplash.com/photo-1548407260-da850faa41e3?w=1200&auto=format&fit=crop&q=80" alt="Fachada de iglesia católica al atardecer" loading="lazy"><p>Patrimonio religioso</p><h3>Inmaculada Concepción</h3><p>60 m² de murales del artista Jorge Aguirre. Iluminación nocturna e misas patronales el 8 de diciembre.</p></a><a href="#tourism-link:que-hacer/mercado-municipal#"><img src="https://images.unsplash.com/photo-1488459716781-31db52582fe9?w=1200&auto=format&fit=crop&q=80" alt="Puesto de mercado con productos frescos" loading="lazy"><p>Vida local</p><h3>Mercado de Abasto</h3><p>Centro comercial de la ciudad. Productos frescos, comida tradicional y hierbas medicinales.</p></a><a href="#tourism-link:que-hacer/parques-y-naturaleza#"><img src="https://images.unsplash.com/photo-1426604966848-d7adac402bff?w=1200&auto=format&fit=crop&q=80" alt="Parque verde con árboles altos" loading="lazy"><p>Familiar</p><h3>Parque Techapyrã</h3><p>Único parque del país con reproducciones de dinosaurios a escala real. 5 hectáreas a 1 km del centro.</p></a>',
  ),
  'ykua-la-patria' =>
  array (
  ...
  array (
    ...
    'body' => '<p>La cocina de Caaguazú se basa en productos locales: maíz, mandioca, gallina criolla y queso paraguayo. El mate y el tereré son parte habitual de la vida cotidiana en el departamento.</p><a href="#tourism-link:sabores-de-caaguazu/platos-tipicos#">Ver platos típicos →</a><a href="#tourism-link:sabores-de-caaguazu/donde-comer#">Ver dónde comer →</a><a href="#tourism-link:sabores-de-caaguazu/mate-y-terere#">Ver mate y tereré →</a>',
  ),
  'platos-tipicos' =>
  array (
  ...
  array (
    ...
    'body' => '<p>Esta sección reúne información sobre el idioma guaraní, las festividades locales y otros aspectos de la vida cotidiana en Caaguazú.</p><a href="#tourism-link:vivir-caaguazu/guarani-en-nuestra-ciudad#">Ver glosario de guaraní →</a><a href="#tourism-link:vivir-caaguazu/festividades#">Ver festividades →</a><a href="#tourism-link:vivir-caaguazu/galeria#">Ver galería →</a>',
  ),
  'festividades' =>
  array (
  ...
  array (
    ...
    'body' => '<p>Caaguazú se encuentra a 180 km al este de Asunción y a 145 km al oeste de Ciudad del Este, sobre la Ruta 7.</p><a href="#tourism-link:planifica-tu-visita/como-llegar#">Ver cómo llegar →</a><a href="#tourism-link:planifica-tu-visita/donde-alojarte#">Ver dónde alojarte →</a><a href="#tourism-link:planifica-tu-visita/mejor-epoca#">Ver mejor época →</a><a href="#tourism-link:planifica-tu-visita/mapa-interactivo#">Ver mapa →</a>',
  ),
  'como-llegar' =>
  array (
