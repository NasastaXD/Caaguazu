...
| # | Hueco | Dónde |
| --- | --- | --- |
| 3 | `[FALTA: rótulo del grupo 1]` | Menú lateral (rótulos y secciones) |
| 10 | `[FALTA: rótulo del grupo 2]` | Menú lateral (rótulos y secciones) |
| 78 | `[FALTA: título del gráfico de actividad]` | Inicio |
...
| 1 | `Administrador` | 175 | |
| 2 | `Invitado` | 177 | |
| 3 | `[FALTA: rótulo del grupo 1]` | 288 | |
| 4 | `Inicio` | 290 | |
| 5 | `Mis contenidos` | 293 | |
| 6 | `Nueva ficha` | 297 | |
| 7 | `Salida de campo` | 298 | |
| 8 | `Cola de revisión` | 301 | |
| 9 | `Tareas` | 302 | |
| 10 | `[FALTA: rótulo del grupo 2]` | 306 | |
| 11 | `Curaduría` | 308 | |
| 12 | `Moderación` | 309 | |
| 13 | `Equipo` | 310 | |
| 14 | `Reportes` | 311 | |
...
| 32 | `Marcar todo leído` | 63 | |
| 33 | `Sin novedades por ahora. ✨` | 69 | |
...
| 40 | `Instalar app` | 70 | |
| 41 | `Enviando…` | 71 | |
| 42 | `Ocurrió un error. Probá de nuevo.` | 72 | |
| 43 | `Guardado` | 73 | |
| 44 | `¿Confirmás esta acción?` | 74 | |
| 45 | `Faltan datos obligatorios` | 75 | |
...
| # | Texto actual | Línea | Nuevo texto |
| --- | --- | --- | --- |
| 46 | `«%s» espera revisión` ⚠️ | 48 | |
| 47 | `atrás` 🔡 | 50 | |
| 48 | `«%s» necesita cambios` ⚠️ | 72 | |
| 49 | `No autorizado.` | 129 | |
...
| 60 | `Descripción` | 93 | |
| 61 | `Faltan fuentes / referencias.` | 123 | |
| 62 | `Mejorá las fotos (luz, encuadre, portada).` | 124 | |
| 63 | `Verificá horarios y costos.` | 125 | |
| 64 | `Revisá ortografía y redacción.` | 126 | |
| 65 | `Precisá el “cómo llegar”.` | 127 | |
...
| 75 | `Inicio` | 55 | |
| 76 | `Tu pulso de hoy` | 60 | |
| 77 | `Hola, %s 👋` ⚠️ | 63 | |
| 78 | `[FALTA: título del gráfico de actividad]` | 86 | |
| 79 | `Actividad de los últimos %d día` ⚠️ | 91 | |
| 80 | `Actividad de los últimos %d días` ⚠️ | 91 | |
| 81 | `Accesos rápidos` | 106 | |
| 82 | `Crear una ficha` | 111 | |
| 83 | `Mis contenidos` | 114 | |
| 84 | `Cola de revisión` | 117 | |
| 85 | `Equipo` | 120 | |
| 86 | `Mi perfil` | 122 | |
...
| 88 | `Tu producción` | 22 | |
| 89 | `+ Nueva ficha` | 25 | |
| 90 | `Todavía no creaste ninguna ficha. ¡Empezá por una!` | 30 | |
...
| 94 | `Editar ficha` | 31 | |
| 95 | `Nueva ficha` | 31 | |
| 96 | `Ficha de destino` | 39 | |
| 97 | `Feedback del revisor` | 47 | |
...
| 106 | `Completá estos puntos para poder enviar a revisión.` | 133 | |
...
| 131 | `Horario y mejor momento` | 133 | |
...
| 148 | `Capturá foto, nota y ubicación aunque no tengas señal. Se guarda en tu dispositivo y lo sincronizás como borrador cuando vuelva la conexión.` | 13 | |
...
| 164 | `Feedback para el autor` | 68 | |
| 165 | `Qué corregir, qué mejorar…` | 69 | |
...
| 174 | `Tareas` | 11 | |
| 175 | `Asignaciones` | 14 | |
| 176 | `Tareas y lo que falta cubrir` | 15 | |
| 177 | `+ Nueva tarea o hueco` | 19 | |
| 178 | `Título` | 21 | |
| 179 | `Detalle` | 22 | |
| 180 | `Tipo` | 24 | |
| 181 | `Tarea asignada` | 26 | |
| 182 | `Hueco (reclamable)` | 27 | |
| 183 | `Vence` | 30 | |
...
| 198 | `Curaduría` | 10 | |
| 199 | `Portada` | 13 | |
| 200 | `Curaduría de la home` | 14 | |
| 201 | `Elegí los destinos destacados y un banner de temporada. La home pública (shortcode [promotur_home]) refleja esto sin tocar código.` | 15 | |
| 202 | `Banner de temporada` | 22 | |
| 203 | `Título (vacío = sin banner)` | 23 | |
| 204 | `Texto` | 24 | |
| 205 | `Enlace (URL)` | 26 | |
| 206 | `Desde` | 27 | |
| 207 | `Hasta` | 28 | |
...
| 219 | `No hay consultas.` | 40 | |
| 220 | `Derivar a un Mini…` | 56 | |
| 221 | `Derivar` | 61 | |
| 222 | `Marcar resuelta` | 64 | |
| 223 | `Reportes de info desactualizada` | 72 | |
| 224 | `Sin reportes abiertos.` | 74 | |
| 225 | `Marcar resuelto` | 83 | |
...
| 229 | `Asignada` | 43 | |
| 230 | `Resuelta` | 44 | |
| 231 | `Completá nombre, email y mensaje.` | 61 | |
| 232 | `Consulta sobre %s` ⚠️ | 64 | |
| 233 | `Consulta general` | 64 | |
| 234 | `[Portal] %s` ⚠️ | 82 | |
| 235 | `De: %1$s <%2$s>` ⚠️ | 83 | |
| 236 | `Destino inválido.` | 139 | |
| 237 | `Contanos qué está desactualizado.` | 142 | |
| 238 | `No se pudo enviar.` | 158 | |
...
| # | Texto actual | Línea | Nuevo texto |
| --- | --- | --- | --- |
| 239 | `Destino inválido.` | 44 | |
| 240 | `Escribí tu reseña.` | 47 | |
| 241 | `Usuario` | 52 | |
| 242 | `Decinos tu nombre.` | 58 | |
| 243 | `No se pudo guardar.` | 74 | |
| 244 | `%s de 5` ⚠️ | 137 | |
| 245 | `Reseñas` | 168 | |
| 246 | `%d reseña` ⚠️ | 175 | |
| 247 | `%d reseñas` ⚠️ | 175 | |
...
| 255 | `Tu reseña se publica luego de una breve moderación.` | 212 | |
...
| 259 | `Generá un enlace de invitación con el rol que elijas (válido 14 días).` | 16 | |
...
| 278 | `Sin búsquedas fallidas registradas.` | 50 | |
| 279 | `%d vez` ⚠️ | 56 | |
| 280 | `%d veces` ⚠️ | 56 | |
| 281 | `Salud del contenido` | 62 | |
...
| 287 | `Tu galería de fotos con créditos y atribución. Por ahora subís imágenes directo desde el editor de cada ficha.` | 10 | |
| 288 | `Abrir la biblioteca de WordPress` | 11 | |
...
| 292 | `Categorías, zonas y etiquetas de los destinos. La edición completa llega en la siguiente fase; mientras tanto, gestionalas desde WordPress.` | 11 | |
| 293 | `Categorías` | 13 | |
| 294 | `Zonas` | 14 | |
| 295 | `Etiquetas` | 15 | |
...
| 300 | `Sin resultados. Probá con otras palabras.` | 32 | |
...
| 303 | `Nivel máximo: publicás directo, con auditoría posterior. ¡Gracias por tu compromiso!` | 49 | |
| 304 | `Promotor Jr: editás fichas publicadas sin re-revisión. Seguí sumando aprobaciones para llegar a "De confianza".` | 51 | |
| 305 | `Aprendiz: todo tu contenido pasa por revisión. Con más aprobaciones desbloqueás autonomía.` | 53 | |
...
| 317 | `Ayuda` | 5 | |
| 318 | `Inicio` | 9 | |
| 319 | `Tu “pulso” del día: cuántas fichas esperan revisión, cuáles necesitan tu corrección y accesos rápidos según tu rol.` | 9 | |
| 320 | `Nueva ficha` | 10 | |
| 321 | `El editor guiado de destinos: campos estructurados + un checklist de mínimos que se valida en vivo y bloquea el envío hasta completarlo.` | 10 | |
| 322 | `Salida de campo` | 11 | |
| 323 | `Capturá foto, nota y ubicación GPS en el lugar, incluso sin señal. Se guarda en tu teléfono y lo sincronizás como borrador cuando vuelve la conexión.` | 11 | |
| 324 | `Mis contenidos` | 12 | |
| 325 | `Todas tus fichas agrupadas por estado: borrador, enviado, en revisión, necesita cambios, publicado.` | 12 | |
| 326 | `Cola de revisión` | 13 | |
| 327 | `Para Promotores: revisá lo enviado, asignátelo, aprobá y publicá, o devolvé con feedback (con comentarios rápidos).` | 13 | |
| 328 | `Tareas` | 14 | |
| 329 | `Asignaciones con fecha límite y el tablero “lo que falta cubrir”: huecos que los Mini Promotores pueden reclamar.` | 14 | |
| 330 | `Curaduría` | 15 | |
| 331 | `Elegí los destacados de la portada y un banner de temporada con vigencia. La home pública se arma sin tocar código.` | 15 | |
| 332 | `Moderación` | 16 | |
| 333 | `Aprobá o descartá reseñas, respondé/derivá consultas de visitantes y resolvé reportes de “info desactualizada”.` | 16 | |
| 334 | `Equipo` | 17 | |
| 335 | `Gestioná a los Mini Promotores: producción, nivel de confianza y enlaces de invitación.` | 17 | |
| 336 | `Reportes` | 18 | |
| 337 | `Producción por autor, lo más visto, búsquedas sin resultado (huecos de contenido) y salud del contenido.` | 18 | |
| 338 | `Mi perfil` | 19 | |
| 339 | `Tu portafolio público, vistas totales y tu progreso de nivel de confianza.` | 19 | |
| 340 | `Cómo funciona` | 22 | |
| 341 | `¿Qué hace cada cosa?` | 23 | |
| 342 | `Este es el portal de los Promotores Turísticos: una web turística pública con un taller editorial detrás. Los Mini Promotores producen las fichas de destino y los Promotores las revisan y publican.` | 25 | |
...
| 348 | `Publicado` | 35 | |
| 349 | `Solo lo que un Promotor aprueba sale al público. La confianza se gana: con más aprobaciones subís de nivel (Aprendiz → Promotor Jr → De confianza) y desbloqueás editar publicadas sin re-revisión y, luego, publicar directo.` | 38 | |
| 350 | `Las secciones` | 42 | |
| 351 | `Extras` | 56 | |
| 352 | `Instalable como app (PWA) con lectura offline desde el menú lateral.` | 58 | |
| 353 | `Cada ficha pública tiene reseñas, “cómo llegar”, código QR para imprimir y botón para sumarla a “Mi viaje” (itinerario).` | 59 | |
| 354 | `Modo claro/oscuro e idioma (ES/EN/GN) desde la barra superior.` | 60 | |
...
| 359 | `Puede que el enlace esté roto o que no tengas acceso.` | 13 | |
| 360 | `Ir al inicio del panel` | 14 | |
...
| 363 | `Tu contraseña fue actualizada. Ya podés entrar.` | 19 | |
| 364 | `Email` | 34 | |
| 365 | `Contraseña` | 38 | |
| 366 | `Mantener sesión` | 42 | |
| 367 | `Entrar` | 45 | |
...
| --- | --- | --- | --- |
| 370 | `Crear cuenta` | 14 | |
| 371 | `Esa invitación ya fue usada.` | 27 | |
| 372 | `Esa invitación expiró. Pedí una nueva al equipo.` | 28 | |
| 373 | `Esa invitación fue revocada.` | 29 | |
| 374 | `El registro es solo por invitación. Pedí tu enlace al equipo de Turismo.` | 30 | |
| 375 | `Ya tengo cuenta` | 35 | |
| 376 | `Invitación válida: te unirás como %s.` ⚠️ | 44 | |
| 377 | `Nombre de usuario` | 55 | |
| 378 | `Email` | 59 | |
| 379 | `Teléfono` | 63 | |
| 380 | `Ej: 0981 123 456` | 64 | |
| 381 | `Contraseña (6+ caracteres)` | 67 | |
...
| 383 | `Te enviamos un enlace para restablecerla.` | 14 | |
| 384 | `Email` | 27 | |
...
| 388 | `Nueva contraseña (6+ caracteres)` | 28 | |
| 389 | `Guardar contraseña` | 31 | |
| 390 | `El enlace no es válido o venció. Pedí uno nuevo.` | 34 | |
...
| # | Texto actual | Línea | Nuevo texto |
| --- | --- | --- | --- |
| 393 | `No autorizado.` | 43 | |
| 394 | `Enlace de invitación creado (válido 14 días): %s` ⚠️ | 49 | |
| 395 | `Sesión expirada. Recargá la página.` | 136 | |
| 396 | `Necesitás una invitación válida para registrarte.` | 175 | |
| 397 | `Completá usuario, email, teléfono y una contraseña de 6+ caracteres.` | 185 | |
| 398 | `Ese email ya tiene una cuenta.` | 189 | |
| 399 | `Si la cuenta existe, te enviamos un email con instrucciones.` | 234 | |
| 400 | `El enlace de restablecimiento venció o no es válido.` | 252 | |
...
| --- | --- | --- | --- |
| 428 | `Enviando…` | 42 | |
| 429 | `Ocurrió un error. Probá de nuevo.` | 43 | |
...
| 450 | `Destacado` | 382 | |
| 451 | `Qué no te podés perder` | 391 | |
...
| # | Texto actual | Línea | Nuevo texto |
| --- | --- | --- | --- |
| 454 | `Sesión expirada. Recargá la página.` | 34 | |
| 455 | `No autorizado.` | 40 | |
| 456 | `¡Gracias! Tu reseña se publicará tras una breve moderación.` | 59 | |
| 457 | `¡Recibimos tu consulta! Te responderemos pronto.` | 73 | |
| 458 | `¡Gracias por avisar! Un Promotor lo va a revisar.` | 88 | |
| 459 | `Acción inválida.` | 102 | |
| 460 | `Faltan datos.` | 112 | |
...
| # | Texto actual | Línea | Nuevo texto |
| --- | --- | --- | --- |
| 462 | `No autorizado.` | 55 | |
| 463 | `Curaduría guardada. La home ya refleja los cambios.` | 76 | |
...
| 489 | `Usuario inválido.` | 151 | |
| 490 | `No podés modificar a un administrador ni a vos mismo desde acá.` | 155 | |
| 491 | `Usuario actualizado.` | 172 | |
| 492 | `Nueva contraseña: %s` ⚠️ | 176 | |
| 493 | `Usuario suspendido (se cerró su sesión).` | 187 | |
...
| 511 | `IP` | 319 | |
| 512 | `Detalle` | 319 | |
| 513 | `Sin registros.` | 323 | |
| 514 | `Actualizaciones del portal` | 380 | |
| 515 | `No se pudo inicializar el verificador de actualizaciones (plugin-update-checker). Revisá que la carpeta vendor/ esté presente.` | 384 | |
| 516 | `Atención: la versión del encabezado del plugin (%1$s) no coincide con la constante PROMOTUR_VERSION (%2$s). El workflow de releases y el updater usan la del encabezado; mantenelas iguales para evitar problemas de publicación.` ⚠️ | 391 | |
...
| 525 | `Limpiar caché del updater` | 433 | |
| 526 | `Token de GitHub` | 437 | |
| 527 | `Definido en wp-config.php mediante la constante PROMOTUR_GITHUB_TOKEN (no editable acá). Tiene prioridad sobre el token guardado en la base de datos.` | 439 | |
| 528 | `El repositorio es público, así que normalmente no hace falta token. Configurá uno solo si el repo pasa a privado o si chocás con el límite de peticiones de GitHub.` | 441 | |
| 529 | `Token` | 447 | |
| 530 | `•••• guardado (dejá vacío para conservarlo)` | 448 | |
| 531 | `Eliminar el token guardado` | 450 | |
| 532 | `Guardar token` | 454 | |
| 533 | `Hay una versión nueva disponible: %s.` ⚠️ | 473 | |
| 534 | `No hay actualizaciones: estás en la última versión.` | 475 | |
| 535 | `El verificador de actualizaciones no está disponible.` | 478 | |
| 536 | `Caché del updater limpiada.` | 487 | |
| 537 | `El token está fijado en wp-config.php; no se puede cambiar desde acá.` | 492 | |
| 538 | `Token eliminado.` | 499 | |
| 539 | `Token guardado.` | 502 | |
| 540 | `Sin cambios en el token.` | 504 | |
...
| # | Texto actual | Línea | Nuevo texto |
| --- | --- | --- | --- |
| 541 | `Sesión expirada. Recargá la página.` | 38 | |
| 542 | `Necesitás iniciar sesión.` | 41 | |
| 543 | `No tenés permiso para esto.` | 44 | |
| 544 | `No podés editar esta ficha.` | 83 | |
| 545 | `(sin título)` | 93 | |
| 546 | `Borrador guardado.` | 127 | |
| 547 | `Guardado. Como editaste una ficha publicada, queda en re-revisión.` | 135 | |
| 548 | `Ficha inválida.` | 152 | |
| 549 | `Faltan datos obligatorios. Completá el checklist antes de enviar.` | 156 | |
| 550 | `Publicación directa por nivel de confianza (auditoría posterior).` | 163 | |
| 551 | `¡Publicado! (nivel de confianza)` | 164 | |
| 552 | `¡Enviado a revisión!` | 167 | |
| 553 | `Te asignaste la revisión.` | 178 | |
| 554 | `Ficha aprobada y publicada.` | 193 | |
| 555 | `Escribí el feedback para el autor.` | 205 | |
| 556 | `Devuelto al autor con feedback.` | 209 | |
| 557 | `No llegó ninguna imagen.` | 216 | |
| 558 | `Solo se permiten imágenes.` | 220 | |
...
| # | Texto actual | Línea | Nuevo texto |
| --- | --- | --- | --- |
| 559 | `Sesión expirada. Recargá la página.` | 28 | |
| 560 | `No tenés permiso.` | 31 | |
| 561 | `Tarea creada.` | 48 | |
| 562 | `Tarea inválida.` | 55 | |
| 563 | `Reclamaste esta tarea. ¡A producir!` | 58 | |
| 564 | `Tarea completada. 🎉` | 72 | |
| 565 | `Usuario inválido.` | 80 | |
...
| # | Texto actual | Línea | Nuevo texto |
| --- | --- | --- | --- |
| 568 | `Caaguazú Portal necesita el plugin "Caaguazú Cuentas" activo para funcionar — el login de los promotores ya no usa usuarios de WordPress. Activalo desde Plugins para que el panel vuelva a andar.` | 90 | |
